...
const styles = StyleSheet.create({
  ...
  archetypeTagline:{ color: '#999', fontSize: 14, textAlign: 'center', lineHeight: 20 },
  ...
  ratingCount:     { color: '#FFF', fontSize: 15, fontWeight: '600', marginBottom: 10 },
  flavourRow:      { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  flavourPill:     { backgroundColor: 'rgba(200,169,110,0.1)', borderRadius: 999, paddingHorizontal: 14, paddingVertical: 6, borderWidth: 1, borderColor: 'rgba(200,169,110,0.2)' },
  flavourPillText: { color: '#C8A96E', fontSize: 12, fontWeight: '600' },
  subStatus:       { color: '#999', fontSize: 15, fontWeight: '600', marginBottom: 10 },
