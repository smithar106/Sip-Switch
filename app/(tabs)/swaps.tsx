...
const styles = StyleSheet.create({
  ...
  swapCard:     { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 14, flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 10 },
  swapFrom:     { color: '#FFF', fontSize: 16, flexShrink: 0, width: 100 },
